...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(solution.findCheapestPrice(17,
        ...
        //        {5, 14, 89}, {11, 16, 13}, {7, 3, 46}, {10, 15, 19}, {12, 4, 58}, {13, 16, 11}, {16, 4, 76}, {2, 0,
        //        12},
        //        {15, 0, 22}, {16, 12, 13}, {7, 1, 29}, {7, 14, 100}, {16, 1, 14}, {9, 6, 74}, {11, 1, 73}, {2, 11,
        //        60},
        ...
        //        {9, 15, 94}, {5, 7, 77}, {4, 10, 18}, {7, 2, 11}, {9, 5, 41}}, 13, 4, 13));
        //System.out.println(
        //    solution.findCheapestPrice(4, new int[][] {{0, 1, 100}, {1, 2, 100}, {2, 0, 100}, {1, 3, 600}, {2, 3, 200}},
        //        0, 3, 1));
        System.out.println(
            solution.findCheapestPrice(3, new int[][] {{0, 1, 100}, {1, 2, 100}, {0, 2, 500}},
                0, 2, 1));
    }
    ...
    public int findCheapestPrice(int n, int[][] flights, int src, int dst, int k) {
        ...
        for (int i = 0; i <= k; i++) {
            ...
            for (int j = 0; j < flights.length; j++) {
                ...
                int end = flight[1];
                int cost = flight[2];
                if (cheapest[start] != Integer.MAX_VALUE) {
